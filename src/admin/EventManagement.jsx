  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-3xl font-black text-gray-800">Event Management</h2>
        <button
        ...
        >
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">External Link (for Unstop Events)</label>
                <input
                  type="url"
      ...
      {filteredEvents.length === 0 && (
        <GlassCard className="p-12 text-center">
          <div className="text-gray-400 text-lg">No {activeTab} events found.</div>
          <button
            onClick={() => setShowForm(true)}
